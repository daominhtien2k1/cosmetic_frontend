...
// Standard and Detail
class SearchReviewContainer extends StatelessWidget {
  final SearchReview review;
  const SearchReviewContainer({Key? key, required this.review}) : super(key: key);
      ...
      child: Column(
        children: [
          ...
          review.video != null ? Padding(
            padding: const EdgeInsets.symmetric(vertical: 0),
            child: SearchReviewVideoContainer(url: review.video?.url ?? VideoPlaceHolder.videoPlaceHolderOnline),
          ) : const SizedBox.shrink(),
          const SizedBox(height: 4),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 12),
            child: _SearchReviewStats(usefuls: review.usefuls, replies: review.replies, isSettedUseful: review.isSettedUseful, onSetUsefulReview: handleSetUsefulReview, onHandleOtherReviewEvent: (event) => handleOtherReviewEvent(event)),
          )
        ],
      ),
    );
...
class _SearchReviewHeader extends StatelessWidget {
  final String avtUrl;
  final String name;
  final String timeAgo;
  final Function(Map event)? onHandleOtherReviewEvent;
  final Map? extras;
  const _SearchReviewHeader({Key? key, required this.avtUrl, required this.name, required this.timeAgo, this.onHandleOtherReviewEvent, this.extras}) : super(key: key);
...
class _SearchReviewStats extends StatelessWidget {
  final int usefuls;
  final int replies;
  ...
  const _SearchReviewStats({Key? key, required this.usefuls,  required this.replies, required this.isSettedUseful, required this.onSetUsefulReview, this.onHandleOtherReviewEvent}) : super(key: key);
...
class _SearchReviewButton extends StatelessWidget {
  final Icon icon;
  final String label;
  final VoidCallback onTap;
  const _SearchReviewButton({Key? key, required this.icon, required this.label, required this.onTap}) : super(key: key);
...
class SearchReviewVideoContainer extends StatefulWidget {
  final String url;
  SearchReviewVideoContainer({Key? key, required this.url}) : super(key: key);

  @override
  State<SearchReviewVideoContainer> createState() => _SearchReviewVideoContainerState();
}

class _SearchReviewVideoContainerState extends State<SearchReviewVideoContainer> {
                ...
                onPressed: () {
                  ...
                  showModalBottomSheet(
                      ...
                      builder: (context) => Container(
                          ...
                          child: ReportSearchReviewBottomSheet(reviewId: reviewId)
                      )
                  );
                }
            )
...
class ReportSearchReviewBottomSheet extends StatefulWidget {
  final String reviewId;
  const ReportSearchReviewBottomSheet({Key? key, required this.reviewId}) : super(key: key);

  @override
  State<ReportSearchReviewBottomSheet> createState() => _ReportSearchReviewBottomSheetState();
}

class _ReportSearchReviewBottomSheetState extends State<ReportSearchReviewBottomSheet> {
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ReportSearchReviewItem(subject: subjectArray[0], onTap: () {
                  setState(() {
                ...
                ReportSearchReviewItem(subject: subjectArray[1], onTap: () {
                  setState(() {
                ...
                Divider(height: 8, color: Colors.blueGrey),
                ReportSearchReviewItem(subject: subjectArray[2], onTap: () {
                  setState(() {
                ...
                Divider(height: 8, color: Colors.blueGrey),
                ReportSearchReviewItem(subject: subjectArray[3], onTap: () {
                  setState(() {
                ...
                Divider(height: 8, color: Colors.blueGrey),
                ReportSearchReviewItem(subject: subjectArray[4], onTap: () {
                  setState(() {
                ...
                Divider(height: 8, color: Colors.blueGrey),
                ReportSearchReviewItem(subject: subjectArray[5], onTap: () {
                  setState(() {
...
class ReportSearchReviewItem extends StatelessWidget {
  final String subject;
  final Function() onTap;
  const ReportSearchReviewItem({Key? key, required this.subject, required this.onTap}) : super(key: key);
